...
export const REBASING_LESSONS: CurriculumLesson[] = [
  {
    ...
    keyTakeaways: [
      ...
      'Rebase gently lifts your feature commits and replays them on top of main\'s freshest rooftop.',
      'A commit hash is calculated using its parent. Changing the parent creates brand-new commit hashes (#201 ➔ #301).',
    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: 'paragraph',
            text: 'Imagine the main branch is a multi-story building. When you branched off to start your feature, main was a 3-story building (commits #101, #102, #103). You built two penthouse rooms on top of floor 3 (commits #201, #202). Meanwhile, your teammates built floors 4 and 5 on main (commits #104, #105). Now, your branch is behind main.',
            textBn: 'main ব্রাঞ্চটিকে একটি বহুতল ভবনের মতো কল্পনা করুন। আপনি যখন আপনার ফিচার ব্রাঞ্চ শুরু করেছিলেন, তখন main ছিল ৩ তলা বিশিষ্ট একটি ভবন (কমিট #১০১, #১০২, #১০৩)। আপনি ৩ তলার ছাদের ওপর নিজের দুটি ঘর তৈরি করলেন (কমিট #২০১, #২০২)। এর মধ্যে আপনার সহকর্মীরা মূল ভবনে আরও দুটি নতুন তলা ৪ এবং ৫ তৈরি করে ফেলেছেন (কমিট #১০৪, #১০৫)। অর্থাৎ আপনার ব্রাঞ্চটি এখন main থেকে পিছিয়ে আছে।',
          },
          {
            type: 'keyConcept',
            title: 'Merge vs. Rebase: Two Different Ways to Connect',
            titleBn: 'মার্জ বনাম রিবেস: সংযুক্ত করার দুটি ভিন্ন উপায়',
            text: '• The Merge Way (Building an External Bridge):\nGit keeps your rooms sitting on floor 3, and builds an external bridge (a special "Merge Commit") connecting floor 3 directly to floor 5. Both paths remain visible as a fork in history.\n\n• The Rebase Way (Lifting to the New Rooftop - Re-BASE):\nGit literally changes your foundation (BASE)! It gently lifts your 2 rooms off floor 3, carries them up, and sets them directly on top of floor 5 (the newest roof). The result is a single, beautiful 7-story straight building with zero clutter!',
            textBn: '• মার্জ পদ্ধতি (বাইরে দিয়ে সেতু জোড়া দেওয়া):\nআপনার ঘরগুলোকে ৩ তলাতেই রেখে গিট ৫ তলার সাথে একটি সংযোগকারী সেতু (একটি বিশেষ "মার্জ কমিট") তৈরি করে। ফলে শাখাটি বাঁকা হয়ে গিয়ে দুটো পথই দৃশ্যমান থাকে।\n\n• রিবেস পদ্ধতি (নতুন ছাদে তুলে নেওয়া - Re-BASE):\nগিট আক্ষরিক অর্থেই আপনার কাজের ভিত্তি (BASE) পরিবর্তন করে! গিট আপনার ঘর দুটিকে ৩ তলা থেকে আলতো করে তুলে নিয়ে সোজা ৫ তলার নতুন ছাদের ওপর বসিয়ে দেয়। এর ফলে কোনো বাঁকা পথ বা অতিরিক্ত সেতু ছাড়া পুরো ভবনটি একটি সোজা ৭ তলা ভবনে পরিণত হয়!',
          },
        ],
      },
      {
        id: 'sec-commit-hashes',
        title: 'Demystifying Commit Hashes: What Are They and Why Do They Change?',
        titleBn: 'কমিট হ্যাশের রহস্য উন্মোচন: হ্যাশ কী এবং রিবেসে এটি কেন বদলায়?',
        blocks: [
          {
            type: 'paragraph',
            text: 'Every commit in Git has a unique digital ID called a **Commit Hash** (e.g., `a1b2c3d...`). Think of it as a unique fingerprint or tracking barcode for that exact snapshot of your code.',
            textBn: 'গিটের প্রতিটি কমিট একটি অনন্য ডিজিটাল পরিচিতি পায় যাকে **কমিট হ্যাশ (Commit Hash)** বলা হয় (যেমন: `a1b2c3d...`)। এটিকে ওই নির্দিষ্ট মুহূর্তের কোডের একটি ফিঙ্গারপ্রিন্ট বা ট্র্যাকিং বারকোড হিসেবে ভাবতে পারেন।',
          },
          {
            type: 'keyConcept',
            title: 'How Does Git Calculate a Hash?',
            titleBn: 'গিট কীভাবে এই হ্যাশ তৈরি করে?',
            text: 'Git calculates each commit\'s hash using a mathematical formula based on 3 things:\n1. The Author, Date, and Commit Message\n2. The exact code changes (diff)\n3. The Hash of the PARENT commit right underneath it!\n\nBecause the hash depends on its parent, if you change who the parent commit is, the hash MUST change!',
            textBn: 'গিট মূলত ৩টি বিষয়ের ওপর ভিত্তি করে গাণিতিক ফর্মুলায় প্রতিটি কমিটের হ্যাশ গণনা করে:\n১. লেখক, তারিখ এবং কমিট মেসেজ\n২. কোডে যে পরিবর্তনগুলো (Diff) করা হয়েছে\n৩. এই কমিটের ঠিক আগের প্যারেন্ট (Parent) কমিটের হ্যাশ আইডি!\n\nযেহেতু হ্যাশ আইডি প্যারেন্টের ওপর নির্ভরশীল, তাই প্যারেন্ট বদলে গেলে স্বয়ংক্রিয়ভাবে একটি সম্পূর্ণ নতুন হ্যাশ তৈরি হওয়া বাধ্যতামূলক!',
          },
          {
            type: 'callout',
            variant: 'note',
            title: 'Concrete Example: Why Rebase Creates Brand-New Hashes',
            titleBn: 'সহজ সংখ্যার উদাহরণে হ্যাশ পরিবর্তন',
            text: 'Let us trace the numbers step-by-step:\n• main branch: Commit #101 ➔ Commit #102 ➔ Commit #103\n• You branched off from #103: Commit #201 (parent: #103) ➔ Commit #202 (parent: #201)\n• Meanwhile, main adds new commits: Commit #104 ➔ Commit #105\n\nWhen you run "git rebase main":\n1. Git takes your changes from #201 and applies them on top of #105. Because its parent is now #105 (not #103), Git calculates a brand-new hash: Commit #301!\n2. Next, commit #202 is applied on top of #301, producing another new hash: Commit #302!\n\nSummary: Your old commits (#201, #202) are replaced by brand-new copies (#301, #302) standing tall on #105.',
            textBn: 'ধাপে ধাপে সহজ সংখ্যার মাধ্যমে হিস্টোরি লক্ষ্য করুন:\n• main ব্রাঞ্চ: কমিট #১০১ ➔ কমিট #১০২ ➔ কমিট #১০৩\n• আপনি #১০৩ থেকে নিজের ব্রাঞ্চ শুরু করেছিলেন: কমিট #২০১ (প্যারেন্ট: #১০৩) ➔ কমিট #২০২ (প্যারেন্ট: #২০১)\n• এদিকে মেইনে নতুন কাজ এলো: কমিট #১০৪ ➔ কমিট #১০৫\n\nএখন আপনি যখন "git rebase main" চালাবেন:\n১. গিট #২০১-এর পরিবর্তনগুলো নিয়ে #১০৫-এর ওপর বসাবে। যেহেতু এর প্যারেন্ট এখন #১০৩-এর বদলে #১০৫, তাই গিট নতুন হ্যাশ তৈরি করবে: কমিট #৩০১!\n২. এরপর #২০২-কে #৩০১-এর ওপর বসিয়ে আরেকটি নতুন হ্যাশ দেবে: কমিট #৩০২!\n\nসারসংক্ষেপ: পুরোনো কমিটগুলো (#২০১, #২০২) মুছে গিয়ে নতুন কপি হিসেবে (#৩০১, #৩০২) সরাসরি #১০৫-এর মাথায় সুন্দরভাবে বসে যাবে।',
          },
        ],
      },
      {
        ...
        blocks: [
          {
            ...
            text: 'Golden Rule: NEVER rebase commits that have already been pushed to a public or shared branch (like main or a team-shared staging branch).\n\nWhy? Because rebase creates BRAND-NEW commit hashes (e.g., Commit #201 becomes #301). If a teammate has already based their work on the old commit #201, rebasing replaces that commit with a different ID. When they pull, Git will become confused and create duplicate commits and painful conflicts for everyone!',
            textBn: 'গোল্ডেন রুল: রিমোট রিপোজিটরির কোনো পাবলিক বা শেয়ার্ড ব্রাঞ্চে (যেমন main বা টিমের সবার ব্রাঞ্চ) পুশ করার পর কখনো রিবেস করবেন না।\n\nকেন? কারণ রিবেস নতুন কমিট হ্যাশ তৈরি করে (যেমন: কমিট #২০১ পরিবর্তিত হয়ে তৈরি হয় #৩০১)। আপনার সহকর্মীরা যদি পুরোনো কমিট #২০১-এর ওপর ভিত্তি করে কাজ শুরু করে থাকেন, আপনার রিবেস সেই আইডিকে পরিবর্তন করে দেবে। ফলে তারা যখন পুল করবে, গিট বিভ্রান্ত হয়ে ডুপ্লিকেট কমিট সৃষ্টি করবে এবং সবার জন্য বড় ধরনের ঝামেলা তৈরি করবে!',
          },
          {
            type: 'paragraph',
